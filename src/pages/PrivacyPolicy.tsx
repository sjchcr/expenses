export default function PrivacyPolicy() {
  return (
    <div>
      ...
      <p>
        This privacy policy applies to the SJ Financial Tracker app (hereby
        referred to as "Application") for mobile devices that was created by
        Steven Jimenez (hereby referred to as "Service Provider") as a Free
      ...
      <p>
        ...
        identifiable information, including but not limited to Email, Name, User
        ID, Financial Info, User Content. The information that the Service
      ...
      <p>
        ...
        Application, please contact them at hello@steven.cr and they will
      ...
      <div>
        <p>
          ...
          (hello@steven.cr) so that they will be able to take the necessary
          actions. You must also be at least 16 years of age to consent to the
          processing of your personally identifiable information in your country
          (in some countries we may allow your parent or guardian to do so on
          your behalf).
        </p>
      </div>
      ...
      <p>
        ...
        Provider via email at hello@steven.cr.
      </p>
    </div>
  );
}
